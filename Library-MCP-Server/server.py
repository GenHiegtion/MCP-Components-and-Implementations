...
class LibraryManagement:
    ...
    # Write the entire current list of books to a JSON file, 
    # ensuring that any changes (adding or deleting books) are consistently saved.
    def save_books(self):
        self.books_path.write_text(json.dumps(self.books, indent=4), encoding="utf-8")

    # Add a new book to the library. 
    # The function will check the validity of the data fields (title, author, ISBN) and avoid duplicate ISBNs. 
    # If successful, the book data is written to the list and updated in the archive file.
    ...
    # If no matching book is found, the function returns an error message. 
    # If the deletion is successful, update the archive data.
    ...
    # Returns the entire list of books as a Python list.
    def get_all_books(self) -> list:
        return self.books

    # Retrieve information about a book based on its index in the list. 
    ...
    # Returns information about a book based on its ISBN. 
    ...
    # Returns a prompt string requesting a suggestion for a random book from the library.
    ...
    # Take an abstract from a book and create a prompt to suggest a suitable, descriptive, and impactful book title.
    ...
    # Create a list of messages (following the conversational structure between the user and assistant) to facilitate the analysis of a book through a conversational model. 
    # The message structure should conform to the format used in applications such as ChatGPT or other intelligent chat systems.
